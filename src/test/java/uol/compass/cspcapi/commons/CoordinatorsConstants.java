...
public class CoordinatorsConstants {
    ...
    public static final ResponseUserDTO RESPONSE_USER_1 = new ResponseUserDTO(1L, "User", "Surname", "user.surname1@mail.com", "linkedInLink");
    public static final ResponseCoordinatorDTO RESPONSE_COORDINATOR_1 = new ResponseCoordinatorDTO(1L, RESPONSE_USER_1);

    public static final ResponseUserDTO RESPONSE_USER_2 = new ResponseUserDTO(2L, "User", "Surname", "user.surname2@mail.com", "linkedInLink");
    public static final ResponseCoordinatorDTO RESPONSE_COORDINATOR_2 = new ResponseCoordinatorDTO(2L, RESPONSE_USER_2);

    public static final ResponseUserDTO RESPONSE_USER_3 = new ResponseUserDTO(3L, "User", "Surname", "user.surname3@mail.com", "linkedInLink");
    ...
    public static final CreateUserDTO USER_7 = new CreateUserDTO("firstName", "lastName", "test4@mail.com", "12345678", "linkedInLink");
}
